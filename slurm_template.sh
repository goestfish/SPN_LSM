...
#SBATCH -t 08:00:00             # total run time limit (HH:MM:SS)  <-- adjust as needed

#SBATCH --mem=32000MB           # memory

#SBATCH --job-name='SPN_LSM_Chexpert'
...
# You can keep using the TF container and just pip-install torch etc.

# If your cluster has a PyTorch container, replace this path with that.
...
echo "Starting main_pipeline.py at $(date)"
